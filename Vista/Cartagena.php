...
<head>
  ...
  <title>Tour por Cartagena histórica</title>
...
<body>
      ...
      <div class="gallery-reserve-wrapper">
        <main class="gallery-section">
          ...
          <section class="gallery">
            <div class="hero">
              <img src="../imagenes/rog-republic-of-gamers-logo_3860x2140_xtrafondos.com.jpg" 
        ...
        <aside class="reserve-sidebar">
          <div class="card">
            <div class="price-section">
              <div>
                <div class="price" id="pricePerNight" data-price="95000"> $95.000 COP</div>
  ...
  <input type="hidden" name="destino_id" value="1"> <!-- ID del destino en la tabla destinos -->
